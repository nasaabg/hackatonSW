...
var Quintus = function a(b) {
    ...
    return c._uniqueId = function() {
        ...
        return c.lastGameLoopFrame = (new Date).getTime(), c.loop = !0, c._loopFrame = 0, c.gameLoopCallbackWrapper = function() {
            ...
            d > c.options.frameTimeLimit && (d = c.options.frameTimeLimit), a.apply(c, [d / 1e3]), c.lastGameLoopFrame = b
    ...
    function() {
        ...
        var b = c._fileExtension(a),
            d = c.assetTypes[b];
        return "Audio" === d && c.audio && "WebAudio" === c.audio.type && (d = "WebAudio"), d || "Other"
    ...
    }, c.loadAssetAudio = function(a, b, d, e) {
        if (!document.createElement("audio").play || !c.options.sound) return d(a, null), void 0;
        var f = c._removeExtension(b),
            g = c._audioAssetExtension(),
            h = new Audio;
        return g ? (h.addEventListener("error", e), c.touchDevice || h.addEventListener("canplaythrough", function() {
            d(a, h)
        }), h.src = c.assetUrl(c.options.audioPath, f + "." + g), h.load(), c.touchDevice && d(a, h), void 0) : (d(a, null), void 0)
...
! function() {
    ...
    a.component("viewport", {
        ...
        init: function(a) {
            this._super(a, {
                ...
                type: 1,
                renderAlways: !0
            }), this.p.dataAsset && this.load(this.p.dataAsset), this.setDimensions(), this.blocks = [], this.p.blockW = this.p.tileW * this.p.blockTileW, this.p.blockH = this.p.tileH * this.p.blockTileH, this.colBounds = {}, this.directions = ["top", "left", "right", "bottom"], this.tileProperties = {}, this.collisionObject = {
                p: {
                    w: this.p.tileW,
                    h: this.p.tileH,
                    cx: this.p.tileW / 2,
        ...
        _generateCollisionObjects: function() {
            function b(a) {
                return [a[0] * c.p.tileW - c.p.tileW / 2, a[1] * c.p.tileH - c.p.tileH / 2]
            }
            var c = this;
            if (this.sheet() && this.sheet().frameProperties) {
                var d = this.sheet().frameProperties;
                for (var e in d) {
                    var f = this.tileCollisionObjects[e] = {
                        p: a._clone(this.collisionObject.p)
                    };
                    a._extend(f.p, d[e]), f.p.points && (f.p.points = a._map(f.p.points, b)), this.tileCollisionObjects[e] = f
                }
            }
        },
        load: function(b) {
            ...
            if ("json" !== e) throw "file type not supported";
            c = a._isString(b) ? a.asset(b) : b, this.p.tiles = c
        },
        setDimensions: function() {
            var a = this.p.tiles;
            a && (this.p.rows = a.length, this.p.cols = a[0].length, this.p.w = this.p.cols * this.p.tileW, this.p.h = this.p.rows * this.p.tileH)
        },
        getTile: function(a, b) {
            return this.p.tiles[b] && this.p.tiles[b][a]
        },
        getTileProperty: function(a, b) {
            return void 0 !== this.tileProperties[a] ? this.tileProperties[a][b] : void 0
        },
        getTileProperties: function(a) {
            return void 0 !== this.tileProperties[a] ? this.tileProperties[a] : {}
        },
        getTilePropertyAt: function(a, b, c) {
            return this.getTileProperty(this.getTile(a, b), c)
        },
        getTilePropertiesAt: function(a, b) {
            return this.getTileProperties(this.getTile(a, b))
        },
        tileHasProperty: function(a, b) {
            return void 0 !== this.getTileProperty(a, b)
        },
        setTile: function(a, b, c) {
            var d = this.p,
                e = Math.floor(a / d.blockTileW),
                f = Math.floor(b / d.blockTileH);
            a >= 0 && a < this.p.cols && b >= 0 && b < this.p.rows && (this.p.tiles[b][a] = c, this.blocks[f] && (this.blocks[f][e] = null))
        },
        ...
        getCollisionObject: function(a, b) {
            var c, d = this.p,
                e = this.getTile(a, b);
            return c = void 0 !== this.tileCollisionObjects[e] ? this.tileCollisionObjects[e] : this.collisionObject, c.p.x = a * d.tileW + d.x + d.tileW / 2, c.p.y = b * d.tileH + d.y + d.tileH / 2, c
        },
        collide: function(b) {
            var c, d, e = this.p,
                f = b.c || b.p,
                g = Math.floor((f.x - f.cx - e.x) / e.tileW),
                h = Math.floor((f.y - f.cy - e.y) / e.tileH),
                i = Math.ceil((f.x - f.cx + f.w - e.x) / e.tileW),
                j = Math.ceil((f.y - f.cy + f.h - e.y) / e.tileH),
                k = this.collisionNormal;
            k.collided = !1;
            for (var l = h; j >= l; l++)
                for (var m = g; i >= m; m++) this.tilePresent(m, l) && (d = this.getCollisionObject(m, l), c = a.collision(b, d), c && c.magnitude > 0 && (d.p.sensor ? (d.tile = this.getTile(m, l), b.trigger && b.trigger("sensor.tile", d)) : (!k.collided || k.magnitude < c.magnitude) && (k.collided = !0, k.separate[0] = c.separate[0], k.separate[1] = c.separate[1], k.magnitude = c.magnitude, k.distance = c.distance, k.normalX = c.normalX, k.normalY = c.normalY, k.tileX = m, k.tileY = l, k.tile = this.getTile(m, l), void 0 !== b.p.collisions && b.p.collisions.push(k))));
            return k.collided ? k : !1
        },
    ...
    }), a.gravityY = 9.8 * 100, a.gravityX = 0, a.component("2d", {
        added: function() {
            var b = this.entity;
            a._defaults(b.p, {
                vx: 0,
        ...
        collision: function(a) {
            ...
            var d = Math.abs(c.vx),
                e = Math.abs(c.vy);
            c.x -= a.separate[0], c.y -= a.separate[1], a.normalY < -.3 && (!c.skipCollide && c.vy > 0 && (c.vy = 0), a.impact = e, b.trigger("bump.bottom", a)), a.normalY > .3 && (!c.skipCollide && c.vy < 0 && (c.vy = 0), a.impact = e, b.trigger("bump.top", a)), a.normalX < -.3 && (!c.skipCollide && c.vx > 0 && (c.vx = 0), a.impact = d, b.trigger("bump.right", a)), a.normalX > .3 && (!c.skipCollide && c.vx < 0 && (c.vx = 0), a.impact = d, b.trigger("bump.left", a))
        },
        step: function(b) {
    ...
    a.canvasToStageX = function(b, c) {
        ...
        enableKeyboard: function() {
            return this.keyboardEnabled ? !1 : (a.el.tabIndex = 0, a.el.style.outline = 0, a.el.addEventListener("keydown", function(b) {
                ...
                b.preventDefault()
            }, !1), a.el.focus(), this.keyboardEnabled = !0, void 0)
        },
        ...
        touchControls: function(b) {
            function c(c) {
                for (var d = a.input.touchLocation(c), e = 0, f = b.controls.length; f > e; e++)
                    if (d.x < b.unit * (e + 1)) return b.controls[e][0]
            }
        ...
        drawButtons: function() {
            ...
            for (var d = 0; d < b.controls.length; d++) {
                ...
                if (e[0]) {
                    ...
                    var f = d * b.unit + b.gutter,
                        g = b.bottom - b.unit,
                        h = a.inputs[e[0]];
                    c.fillStyle = b.color || "#FFFFFF", c.globalAlpha = h ? 1 : .5, c.fillRect(f, g, b.size, b.size), c.fillStyle = b.text || "#000000", c.fillText(e[1], f + b.size / 2, g + b.size / 2)
                }
            }
            c.restore()
        },
        ...
        added: function() {
            var a = this.entity.p;
            a.stepDistance || (a.stepDistance = 32), a.stepDelay || (a.stepDelay = .2), a.stepWait = 0, this.entity.on("step", this, "step"), this.entity.on("hit", this, "collision")
        },
        collision: function() {
            var a = this.entity.p;
    ...
    return a.Class.extend("SpriteSheet", {
        init: function(b, c, d) {
            ...
            a._extend(this, {
                ...
                spacingY: 0,
                frameProperties: {}
            }), d && a._extend(this, d), this.tilew && (this.tileW = this.tilew, delete this.tilew), this.tileh && (this.tileH = this.tileh, delete this.tileh), this.cols = this.cols || Math.floor(this.w / (this.tileW + this.spacingX)), this.frames = this.cols * Math.ceil(this.h / (this.tileH + this.spacingY))
        },
        fx: function(a) {
        ...
        if (b.matrix || b.refreshMatrix) {
            ...
            var c = b.p,
                d = b.c;
            if (c.moved || d.origX !== c.x || d.origY !== c.y || d.origScale !== c.scale || d.origScale !== c.angle) {
    ...
    a.assetTypes.tmx = "TMX", a.loadAssetTMX = function(b, c, d, e) {
        ...
        var d = a._isString(b) ? a.asset(b) : b,
            e = {}, f = d.getElementsByTagName("tileset"),
    ...
    a.UI = {}, a.UI.roundRect = function(a, b) {
        ...
        font: function() {
            return this.fontString ? this.fontString : (this.fontString = (this.p.weight || "800") + " " + (this.p.size || 24) + "px " + (this.p.family || "Arial"), this.fontString)
        }
        ...
        init: function(b, c) {
            if (this._super(a._defaults(b, {
                ...
                var d = a.ctx.measureText(this.p.label);
                a.ctx.restore(), this.p.h || (this.p.h = 44), this.p.w || (this.p.w = d.width + 20)
            }
            isNaN(this.p.cx) && (this.p.cx = this.p.w / 2), isNaN(this.p.cy) && (this.p.cy = this.p.h / 2), this.callback = c, this.on("touch", this, "highlight"), this.on("touchEnd", this, "push")
        },
        highlight: function() {
